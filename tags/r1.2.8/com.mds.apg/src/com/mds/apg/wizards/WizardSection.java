...
abstract public class WizardSection {
    private boolean mInternalPathUpdate = false;
    ...
    abstract String getLocationSave();
    
    abstract void setLocationSave(String s);
    ...
    void update(String abs_dir) {
        if (!mInternalPathUpdate) {
            ...
            if (abs_dir != null) {
                ...
                // the exact same path.
                setLocationSave(TextProcessor.process(abs_dir));
            }
            Text pathValue = getRawValue();
            String staticSave = getLocationSave();
